...
import os
import sys
window_title   = f"WARP-PLUS-CLOUDFLARE By SID45C1AY "
os.system('title ' + window_title if os.name == 'nt' else 'PS1="\[\e]0;' + window_title + '\a\]"; echo $PS1')
os.system('cls' if os.name == 'nt' else 'clear')
os.system("figlet S 1 D 4 5 C 1 A Y")
print("Proper Credit To ALIILAPRO")
...
while True:
	os.system('cls' if os.name == 'nt' else 'clear')
	print("")
	print("                  WARP-PLUS-CLOUDFLARE (script)" + " By SID45C1AY")
	print("                         Proper Credit " + "to ALIILAPRO    ❤")
	print("")
